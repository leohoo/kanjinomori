...
- [ ] Doors trigger question screens correctly
- [ ] Side-scroll battle with jump, attack, shield working
- [ ] Aerial attacks deal 80% damage with +5% crit
- [ ] Enemy AI jumps and attacks appropriately
- [ ] Jump effects (wind lines) display correctly
- [ ] Coin rewards match spec (+5 per question, +10 bonus)
...
| Phase | Components |
|-------|------------|
| Phase 1: Foundation | Dependencies, base classes, asset sourcing |
| Phase 2: Field | Isometric map, player movement, doors, camera |
| Phase 3: Battle | Combat system, enemy AI, controls |
| Phase 4: Polish | Effects, transitions, audio |
| Phase 5: Integration | Navigation, state management, persistence |
